<footer class="bg-darker-grey text-white">
    <div class="container">
            ...
            <div class="w-full md:w-fit md:ml-auto">
                ...
                <ul class="space-x-4 sm:space-x-2 lg:space-x-4 flex items-center mb-8">
                    ...
                    <li class="w-10 h-10 rounded-full flex items-center justify-center p-2.5 bg-[#1DA1F2]">
                        <span class="iconify text-white" data-icon="basil:twitter-solid" data-width="22"
                            data-height="22"></span>
                    </li>
                </ul>

                <h6 class="text-white font-bold mb-6">Follow Us</h6>
                <img src="./assets/images/visa.png" alt="Logo" class="h-[65px] w-auto mb-8" />
                ...
                <div class="w-fit border border-dark-grey p-4 rounded-lg flex items-center gap-x-4 gap-y-2">
                    <div class="relative inline-block group">
                        <div class="cursor-pointer text-base text-white font-semibold flex items-center gap-2">
                            <span class="iconify text-green-zomp" data-icon="solar:global-linear" data-width="18"
                                data-height="18"></span>
                            <p>English</p>
                        </div>
                        <div
                            class="absolute shadow-shadow-custom right-0 left-0 md:left-auto bottom-11 py-6 px-4 w-72 bg-white rounded-lg invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-200 z-50">
                            ...
                            <div class="grid grid-cols-2 gap-x-4">
                                <ul>
                                    <li class="mb-2.5 last:mb-0 cursor-pointer text-dark-grey hover:text-green-zomp">
                                        English</li>
                                    <li class="mb-2.5 last:mb-0 cursor-pointer text-dark-grey hover:text-green-zomp">
                                        Français</li>
                                    <li class="mb-2.5 last:mb-0 cursor-pointer text-dark-grey hover:text-green-zomp">
                    ...
                    <div class="relative flex items-center gap-1">
                        <select
                            class="bg-transparent px-2 appearance-none text-base font-semibold border-none outline-none ring-0 focus:outline-none focus:ring-0 focus:border-transparent cursor-pointer">
        ...
        <div class="py-[22px] text-center text-grey">
            <p>Copyright © 2023 Travel WP. All Rights Reserved.</p>
        </div>
    </div>
</footer>
