                    ...
                    <div class="card-body main-card-body">
                        ...
                        <form action="{{ route('admin.tours.update', $tour->id) }}" method="POST"
                                        ...
                                        @if ($tour->cover_image)
                                            <div class="mb-3">
                                                <img src="{{ asset('uploads/tours/' . $tour->cover_image) }}"
                                                    alt="{{ $tour->title }}" class="img-thumbnail rounded"
                                                                ...
                                                                <div class="col-md-8 mb-3">
                                                                    ...
                                                                    <div class="mb-2">
                                                                        <img src="{{ asset('uploads/tours/' . $image->image) }}"
                                                                            alt="Tour Image" class="img-thumbnail rounded"
                            ...
                            <div class="section-card">
                                ...
                                <div class="section-body">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <p class="text-muted mb-0">Add optional variants like extra days, services, or
                                            upgrades with additional time and price</p>
                                    ...
                                    <div id="tourVariantsContainer">
                                        @if ($tour->tourVariants && $tour->tourVariants->count() > 0)
                                            @foreach ($tour->tourVariants as $index => $variant)
                                                <div class="card mb-3 variant-item" data-variant-id="{{ $variant->id }}"
                                                    style="border: 1px solid #3a3d4a; border-radius: 8px;">
                                                    <div class="card-header d-flex justify-content-between align-items-center"
                                                        style="background: #252836; border-bottom: 1px solid #3a3d4a;">
                                                        <h6 class="mb-0" style="color: #e4e6eb;">
                                                    ...
                                                    <div class="card-body">
                                                        <input type="hidden" name="tour_variants[{{ $variant->id }}][id]"
                                                            value="{{ $variant->id }}">
                                                        <div class="row">
                                                            <div class="col-md-12 mb-3">
                                                                <label class="form-label">Title <span
                                                                        class="text-danger">*</span></label>
                                                                <input type="text" class="form-control variant-title"
                                                                    name="tour_variants[{{ $variant->id }}][title]"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 mb-3">
                                                                ...
                                                                <textarea class="form-control"
                                                                    name="tour_variants[{{ $variant->id }}][description]"
                                                                    rows="2">{{ $variant->description }}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-4 mb-3">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    name="tour_variants[{{ $variant->id }}][additional_duration]"
                                                                    value="{{ $variant->additional_duration }}" min="0">
                                                            </div>
                                                            <div class="col-md-4 mb-3">
                                                                <label class="form-label">Duration Type</label>
                                                                <select class="form-select"
                                                                    name="tour_variants[{{ $variant->id }}][additional_duration_type]">
                                                                    <option value="days" {{ $variant->additional_duration_type == 'days' ? 'selected' : '' }}>
                                                                        Days</option>
                                                                    <option value="hours" {{ $variant->additional_duration_type == 'hours' ? 'selected' : '' }}>
                                                                        Hours</option>
                                                                </select>
                                                            </div>
                                                            <div class="col-md-4 mb-3">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    name="tour_variants[{{ $variant->id }}][additional_price]"
                                                                    value="{{ $variant->additional_price }}" step="0.01" min="0">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <select class="form-select"
                                                                    name="tour_variants[{{ $variant->id }}][status]">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                <label class="form-label">Sort Order</label>
                                                                <input type="number" class="form-control"
                                                                    name="tour_variants[{{ $variant->id }}][sort_order]"
                                            ...
                                            @endforeach
                                        @else
                                            <p class="text-muted mb-0 text-center py-4">No variants added yet. Click "Add
                                                Variant" to add optional add-ons.</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
...
@push('js')
    <script>
        ...
        $(document).ready(function () {
            ...
            let variantCounter = {{ $tour->tourVariants->count() ?? 0 }};
