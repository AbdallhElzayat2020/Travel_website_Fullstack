                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('grid_columns') is-invalid @enderror" id="grid_columns"
                                    name="grid_columns">
                                    <option value="2" {{ old('grid_columns', $category->grid_columns ?? '4') == '2' ? 'selected' : '' }}>2 Columns</option>
                                    <option value="3" {{ old('grid_columns', $category->grid_columns ?? '4') == '3' ? 'selected' : '' }}>3 Columns</option>
                                    <option value="4" {{ old('grid_columns', $category->grid_columns ?? '4') == '4' ? 'selected' : '' }}>4 Columns</option>
                                </select>
                                @error('grid_columns')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="color"
                                    ...
                                    value="{{ old('header_background_color', $category->header_background_color ?? '#ffffff') }}">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="color"
                                    ...
                                    value="{{ old('header_text_color', $category->header_text_color ?? '#000000') }}">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('card_style') is-invalid @enderror" id="card_style"
                                    name="card_style">
                                    <option value="default" {{ old('card_style', $category->card_style ?? 'default') == 'default' ? 'selected' : '' }}>Default</option>
                                    <option value="modern" {{ old('card_style', $category->card_style ?? 'default') == 'modern' ? 'selected' : '' }}>Modern</option>
                                    <option value="classic" {{ old('card_style', $category->card_style ?? 'default') == 'classic' ? 'selected' : '' }}>Classic</option>
                                </select>
                                @error('card_style')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-check form-switch mt-4">
                                    <input class="form-check-input" type="checkbox" id="show_breadcrumb"
                                        name="show_breadcrumb" {{ old('show_breadcrumb', $category->show_breadcrumb ?? true) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-check form-switch mt-4">
                                    <input class="form-check-input" type="checkbox" id="show_description"
                                        name="show_description" {{ old('show_description', $category->show_description ?? true) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('custom_css') is-invalid @enderror" id="custom_css"
                                    ...
                                    placeholder="Enter custom CSS code here...">{{ old('custom_css', $category->custom_css) }}</textarea>
